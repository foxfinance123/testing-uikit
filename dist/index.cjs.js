    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            !isMobile && links.map(function (entry) {
                ...
                if (entry.items) {
                    return (React__default['default'].createElement(Dropdown, { key: entry.label, position: "bottom", target: React__default['default'].createElement(Icon, __assign({}, iconElement), entry.label) }, entry.items.map(function (item) { return (React__default['default'].createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "textSubtle" }, item.label)); }))
                    // <Accordion2
                    //     key={entry.label}
                    //     isPushed={isPushed}
                    //     pushNav={setIsPushed}
