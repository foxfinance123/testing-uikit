...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$t, { width: "24px", color: "primary" })) : (React.createElement(Icon$u, { width: "24px", color: "primary" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "FoxFinance home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "FoxFinance home page" }, innerLogo))));
};
var templateObject_1$c;
