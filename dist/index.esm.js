    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            !isMobile && links.map(function (entry) {
                ...
                if (entry.items) {
                    return (React.createElement(Dropdown, { key: entry.label, position: "bottom", target: React.createElement(Icon, __assign({}, iconElement), entry.label) }, entry.items.map(function (item) { return (React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "textSubtle" }, item.label)); }))
                    // <Accordion2
                    //     key={entry.label}
                    //     isPushed={isPushed}
                    //     pushNav={setIsPushed}
